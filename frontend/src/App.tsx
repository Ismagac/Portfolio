      ...
      {showSplash ? (
        ...
        <div className={
          ...
          <section id="sobre-mi" className="w-full max-w-6xl mt-20 mb-16">
            <div className="bg-gradient-to-br from-purple-900/30 to-purple-600/10 backdrop-blur-md border border-purple-500/20 rounded-xl p-8 shadow-xl hover:shadow-purple-500/20 transition-all duration-500 transform hover:translate-y-[-5px]">
              <div className="flex items-center mb-6">
                <div className="h-10 w-1 bg-gradient-to-b from-purple-400 to-fuchsia-600 rounded-full mr-4"></div>
                <h3 className="text-3xl font-medium bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-fuchsia-500">About Me</h3>
              </div>
              <p className="text-lg leading-relaxed ml-2 pl-4 border-l border-purple-500/30">
          ...
          <section id="proyectos" className="w-full max-w-6xl mb-16">
            <div className="bg-gradient-to-br from-cyan-900/30 to-blue-600/10 backdrop-blur-md border border-cyan-500/20 rounded-xl p-8 shadow-xl hover:shadow-cyan-500/20 transition-all duration-500 transform hover:translate-y-[-5px]">
              <div className="flex items-center mb-6">
                <div className="h-10 w-1 bg-gradient-to-b from-cyan-400 to-blue-600 rounded-full mr-4"></div>
                <h3 className="text-3xl font-medium bg-clip-text text-transparent bg-gradient-to-r from-cyan-400 to-blue-500">Projects</h3>
              </div>
              <p className="text-lg leading-relaxed ml-2 pl-4 border-l border-cyan-500/30">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
                <div className="bg-white/5 backdrop-blur-sm border border-white/10 p-4 rounded-lg hover:border-white/30 transition-all">
          ...
          <section id="contacto" className="w-full max-w-6xl mb-24">
            <div className="bg-gradient-to-br from-emerald-900/30 to-teal-600/10 backdrop-blur-md border border-emerald-500/20 rounded-xl p-8 shadow-xl hover:shadow-emerald-500/20 transition-all duration-500 transform hover:translate-y-[-5px]">
              <div className="flex items-center mb-6">
                <div className="h-10 w-1 bg-gradient-to-b from-emerald-400 to-teal-600 rounded-full mr-4"></div>
                <h3 className="text-3xl font-medium bg-clip-text text-transparent bg-gradient-to-r from-emerald-400 to-teal-500">Contact</h3>
              </div>
              <p className="text-lg leading-relaxed ml-2 pl-4 border-l border-emerald-500/30 mb-6">
              ...
              <div className="flex flex-wrap gap-4 mt-6 justify-center">
                <button className="flex items-center gap-2 bg-white/10 backdrop-blur-sm px-6 py-3 rounded-full border border-white/20 hover:bg-white/20 transition-all">
